...
/**
 * @file
 * Basic cart Braintree shopping cart html template
 */
?>
...
$node = node_load($cart[$value]);
      ...
      print '<div class="basic-cart-cart-quantity cell">' . $_SESSION['basic_cart_braintree']['cart'][$cid. 'quantity'] . '</div>';
      print '<div class="basic-cart-cart-x cell">x</div>';
      print '<div class="basic-cart-cart-unit-price cell">';
      print '<strong>' . basic_cart_braintree_price_format($node->price["und"][0]["value"]) . '</strong>';
      print '</div>';
      print '</div>';
}
}
