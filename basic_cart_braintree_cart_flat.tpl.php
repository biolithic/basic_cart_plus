      ...
      <?php foreach($cart as $nid => $node): ?>
        <div class="basic-cart-cart-contents row">
          ...
          <div class="cell basic-cart-cart-unit-price">
            <?php if (!isset($node->basic_cart_braintree_unit_price)) $node->basic_cart_braintree_unit_price = 0; ?>
            <strong><?php print basic_cart_braintree_price_format($node->basic_cart_braintree_unit_price); ?></strong>
          </div>
          <div class="cell basic-cart-cart-x">x</div>
          <div class="basic-cart-cart-quantity cell"><?php print $node->basic_cart_braintree_quantity; ?></div>
